...
export class UserDetailComponent implements OnInit {
  ...
  updateProfile(){
    const{id,firstname,lastname,email,country,state,address,phone} = this.updateForm;
    this.userService.updateProfile(id,firstname,lastname,email,country,state,address,phone).subscribe({
      next: res =>{
        this.getUser();
        Swal.fire({
          title: 'GUARDADO',
